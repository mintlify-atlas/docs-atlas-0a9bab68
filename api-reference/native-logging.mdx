...
<ResponseField name="libVersion" type="string">
...
<ResponseField name="isUseCoreML" type="boolean">
...
<ResponseField name="isCoreMLAllowFallback" type="boolean">
...
- [Core ML Acceleration](/features/coreml-acceleration) - Setting up Core ML on iOS
